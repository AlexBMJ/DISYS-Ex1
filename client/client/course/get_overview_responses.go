...
/* GetOverviewOK describes a response with status code 200, with default header values.
...
func (o *GetOverviewOK) Error() string {
	return fmt.Sprintf("[GET /courses][%d] getOverviewOK  %+v", 200, o.Payload)
}
func (o *GetOverviewOK) GetPayload() []*models.Course {
	return o.Payload
}
