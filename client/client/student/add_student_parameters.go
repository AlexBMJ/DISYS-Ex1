...
type AddStudentParams struct {
	...
	/* Body.
	   ...
	   Student that needs to be added to ITU
	*/
	Body *models.Student
...
// WithBody adds the body to the add student params
func (o *AddStudentParams) WithBody(body *models.Student) *AddStudentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add student params
func (o *AddStudentParams) SetBody(body *models.Student) {
	o.Body = body
}
