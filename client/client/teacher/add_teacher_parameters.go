...
type AddTeacherParams struct {
	...
	/* Body.
	   ...
	   Teacher that needs to be added to ITU
	*/
	Body *models.Teacher
...
// WithBody adds the body to the add teacher params
func (o *AddTeacherParams) WithBody(body *models.Teacher) *AddTeacherParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add teacher params
func (o *AddTeacherParams) SetBody(body *models.Teacher) {
	o.Body = body
}
