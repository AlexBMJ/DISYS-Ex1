...
// WithTeacherID adds the teacherID to the delete teacher params
func (o *DeleteTeacherParams) WithTeacherID(teacherID int64) *DeleteTeacherParams {
	o.SetTeacherID(teacherID)
	return o
}

// SetTeacherID adds the teacherId to the delete teacher params
func (o *DeleteTeacherParams) SetTeacherID(teacherID int64) {
